...
inline JsonEncoder<std::vector<float>> get_fft_bands_encoder(const std::vector<std::string> labels)
{
    return [labels](const std::string& signal, const std::vector<float>& values) -> std::string {
